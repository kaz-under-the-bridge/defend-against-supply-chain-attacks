...
- Socket.dev GitHub App が kaz-under-the-bridge org の全リポジトリで有効化済み (2026-03-31)
...
2. **Organization** → **kaz-under-the-bridge** を選択
...
```
1. https://github.com/kaz-under-the-bridge/ai-steward/settings/branches
